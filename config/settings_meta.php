...
return [
    'groups' => [
        ...
        // Long-strategy variant groups land here in Phase 3.
        [
            'id' => 'short_scalp_breaker',
            'title' => 'Short-Scalp Circuit Breaker',
            'description' => 'Per-strategy drawdown breaker. Halts new short entries when this strategy\'s P&L drawdown breaches the threshold. window_hours=0 uses all-time peak since last trip (the legacy semantics short_scalp was validated against).',
            'keys' => [
                'strategy.short_scalp.circuit_breaker.enabled',
                'strategy.short_scalp.circuit_breaker.drawdown_pct',
                'strategy.short_scalp.circuit_breaker.window_hours',
                'strategy.short_scalp.circuit_breaker.cooldown_hours',
            ],
        ],
    ],
    ...
    'descriptions' => [
        ...
        // Risk — short_scalp circuit breaker (per-strategy)
        'strategy.short_scalp.circuit_breaker.enabled' => 'Block new short entries when this strategy\'s drawdown breaches the threshold.',
        'strategy.short_scalp.circuit_breaker.drawdown_pct' => 'Peak-to-trough drawdown % that trips the breaker (production: 20).',
        'strategy.short_scalp.circuit_breaker.window_hours' => 'Lookback window in hours. 0 = all-time peak since last trip (legacy semantics, preserves short_scalp\'s validated 20%/4h config). >0 = real sliding window.',
        'strategy.short_scalp.circuit_breaker.cooldown_hours' => 'Hours to block new short entries after a trip (production: 4).',
    ],
    ...
    'constraints' => [
        ...
        'strategy.short_scalp.circuit_breaker.drawdown_pct' => ['min' => 0.1, 'max' => 100, 'step' => 0.5],
        'strategy.short_scalp.circuit_breaker.window_hours' => ['min' => 0, 'step' => 1],
        'strategy.short_scalp.circuit_breaker.cooldown_hours' => ['min' => 0.1, 'step' => 1],
    ],
];
